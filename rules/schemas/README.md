...
- `workflow_stage`、`original_task_scope` 和 `confirmation_checkpoint` 对历史 Requirement Model 均为可选；新 confirmation_only 阶段由运行时交叉校验强制完整，旧 pending Manifest 和 passed 正式产物无需迁移。
